...
public interface UserWechatIdentityMapper {
    ...
    @Select("SELECT id,user_id,openid,unionid FROM user_wechat_identity WHERE user_id=#{userId} LIMIT 1")
    UserWechatIdentity selectByUserId(@Param("userId") Long userId);
